...
typedef enum {
    ...
    EAT_PIN10_RI = 10,        /* GPIO */
    EAT_PIN11_DCD = 11,        /* GPIO */
    EAT_PIN12_CTS = 12,      /* GPIO, EINT */  
    ...
    EAT_PIN55_ROW3 = 55,     /* GPIO, KEY_ROW , EINT*/
    EAT_PIN56_ROW2 = 56,     /* GPIO, KEY_ROW */
    EAT_PIN57_ROW1 = 57,     /* GPIO, KEY_ROW , EINT*/
    EAT_PIN58_ROW0 = 58,     /* GPIO, KEY_ROW */
    EAT_PIN59_COL3 = 59,     /* GPIO, KEY_COL */
    EAT_PIN60_COL2 = 60,     /* GPIO, KEY_COL , EINT*/
    EAT_PIN61_COL1 = 61,     /* GPIO, KEY_COL , EINT*/
